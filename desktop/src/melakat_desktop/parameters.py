...
CORE_SCHEMA = ParameterSchema(
    specs=(
        ...
        ParameterSpec("world.initial_energy", "Initial energy pool", "World", "number", 1000.0, 0.0, 1_000_000.0, 1.0),
        ParameterSpec("world.energy_input_per_tick", "Energy input per tick", "World", "number", 10.0, 0.0, 1_000_000.0, 0.1),
